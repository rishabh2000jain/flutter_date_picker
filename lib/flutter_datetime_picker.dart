...
import 'package:flutter_datetime_picker/src/datetime_picker_theme.dart' as datePicker;
...
class DatePicker {
  ...
  static Future<DateTime?> showDatePicker(
    ...
    DateTime? currentTime,
        datePicker.DatePickerTheme? theme,
...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        this.theme = theme ?? datePicker.DatePickerTheme(),
  ...
  final datePicker.DatePickerTheme theme;
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    datePicker.DatePickerTheme theme = widget.route.theme;
  ...
  Widget _renderPickerView( datePicker.DatePickerTheme theme) {
  ...
  Widget _renderItemView( datePicker.DatePickerTheme theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView( datePicker.DatePickerTheme theme) {
